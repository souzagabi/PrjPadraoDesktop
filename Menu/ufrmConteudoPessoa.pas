...
procedure TfrmConteudoPessoa.rctBtnConPessoaClick(Sender: TObject);
begin
  //
end;
...
//****************************************************************************\\
procedure TfrmConteudoPessoa.ChangeMouseLeave(Sender: TObject);
var nome : string;
...
procedure TfrmConteudoPessoa.ChangeMouseMove(Sender: TObject;
